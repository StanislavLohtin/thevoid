  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.messages}>
        <Message id={1} name={"News Room"} avaUrl={avaUrl[0]} text={"Friday float specials!"} time={new Date(2021,8 ,20 ,9,40)} incoming={true}/>
        <Message id={2} name={"Titirangi Community Chat"} avaUrl={avaUrl[0]} text={"Ok, thanks!"} time={new Date(2021,8 ,20 ,9,25)} incoming={false}/>
        <Message id={3} name={"Support"} avaUrl={avaUrl[0]} text={"Ok, See you in Titirangi! P.S.: Cut this long Text"} time={new Date(2021,8 ,13 ,9,25)} incoming={false}/>
      </View>
    </View>
  );
}
